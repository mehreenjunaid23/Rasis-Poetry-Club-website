                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                            <h1>Rasis</h1>
                            <span class="subheading">"You can make anything by writing" <br>-C.S.Lewis</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="post-preview">
                        <a href="post.php">
                            <h2 class="post-title">Poem 1 Title</h2>
                            <h3 class="post-subtitle">Poem 1 text</h3>
                        </a>
                        <p class="post-meta">
                            Posted by
                            <a href="#!">Author</a>
                    ...
                    <div class="post-preview">
                      <a href="post.php">
                          <h2 class="post-title">Poem 2 Title</h2>
                          <h3 class="post-subtitle">Poem 2 text</h3>
                      </a>
                        <p class="post-meta">
                            Posted by
                            <a href="#!">Author</a>
                    ...
                    <div class="post-preview">
                        <a href="post.php">
                            <h2 class="post-title">Poem 3 Title</h2>
                            <h3 class="post-subtitle">Poem 3 text</h3>
                        </a>
                        <p class="post-meta">
                            Posted by
                            <a href="#!">Author</a>
                    ...
                    <div class="post-preview">
                        <a href="post.php">
                            <h2 class="post-title">Poem 4 Title</h2>
                            <h3 class="post-subtitle">Poem 4 text</h3>
                        </a>
                        <p class="post-meta">
                            Posted by
                            <a href="#!">Author</a>
