    ...
    <body>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Post a New Poem</h1>
                            <span class="subheading">Have a new poem? Post it here now!</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main class="mb-4">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <p>Have a new poem in mind? Enter it below!</p>
                        <div class="my-5">
                            <!-- * * * * * * * * * * * * * * *-->
                            ...
                            <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                                ...
                                <div class="form-floating">
                                    <input class="form-control" id="genre" type="text" placeholder="Enter your genre..." data-sb-validations="required" />
                                    <label for="genre">Genre</label>
                                    <div class="invalid-feedback" data-sb-feedback="genre:required">A genre is required.</div>
                                <!-- </div>
                                <div class="form-floating">
                                    <input class="form-control" id="text" type="text" placeholder="Enter your poem..." data-sb-validations="required" />
                                    <label for="text">Poem Text</label>
                                    <div class="invalid-feedback" data-sb-feedback="text:required">A poem is required.</div>
                                </div> -->
                                <div class="form-floating">
                                    <textarea class="form-control" id="text" placeholder="Enter your poem here..." style="height: 12rem" data-sb-validations="required"></textarea>
                                    <label for="text">Poem Text</label>
                                    <div class="invalid-feedback" data-sb-feedback="text:required">A poem is required.</div>
                                </div>
                                <br />
