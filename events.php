                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Come see us!</h1>
                            <span class="subheading">We will be pleased to welcome you to our events.</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- Main Content-->
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
					...
					<p>Description <br> Event Date: <br> Event Time: <br> Event Location:</p>
                    </div>
					<hr>
					...
					<hr>
                    <div class="d-flex justify-content-end mb-4"><a class="btn btn-primary text-uppercase" href="#!">Other Events →</a></div>
                </div>
            </div>
        </div>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        ...
                        <div class="small text-center text-muted fst-italic">Copyright &copy; Rasis</div>
                    </div>
                </div>
            </div>
			</div>
