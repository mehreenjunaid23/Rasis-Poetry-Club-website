                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="post-heading">
                            <h1>Read All of Our Poems Here</h1>
                            <h2 class="subheading">In All Genres!</h2>
                            <!-- <span class="meta">
                                Posted by
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                      <?php
                              ...
                              $sql = "select * from poems where genre ='Educational'";
                              $result = mysqli_query($connection,$sql);

                              echo "<table class='table table-striped'>";
                              if (mysqli_num_rows($result)) {// check if your query return result
                                echo "<tr> <th> Title </th> <th> Genre </th> <th> Poem </th> <th> Author </th> <th> Date </th> <th> Likes </th> <th> Comments </th></tr>";
                              }
                              else {
                                echo "Poems coming soon...";
                              }
