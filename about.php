    ...
    <body>
        ...
        <main class="mb-4">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <p>The motive of our website is to inspire and motivate writers to regularly write and share their own poems. In the future, our goal is to collect all these poems and combine them in a book that will be officially published.</p>
                    </div>
                </div>
            </div>
        </main>
